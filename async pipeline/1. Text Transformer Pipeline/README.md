...
```
Add README documenting async pipeline architecture and backpressure behavior
```

### Short alternative

```
Add README for async pipeline project
```

---

### ✅ Best pair to use together

For code:

```
Implement async multi-stage text pipeline with backpressure and sentinels
```
